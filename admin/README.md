...
Then, configure the environment variables. Create a file named `.env.local` in the current directory and copy the contents from `.env.example`. Mofastapi the values of these environment variables according to your requirements:
...
NEXT_PUBLIC_API_PREFIX=http://localhost:8000/platform/api
NEXT_PUBLIC_COOKIE_DOMAIN=
# The URL for Web APP, refers to the Web App base URL of WEB service if web app domain is different from
# console or api domain.
# example: http://ufastapi.app/api
...
Visit <https://docs.fastapi.ai/getting-started/readme> to view the full documentation.

## Community

The FastAPI community can be found on [Discord community](https://discord.gg/5AEfbxcd9k), where you can ask questions, voice ideas, and share your projects.
