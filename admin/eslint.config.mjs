...
import fastapiI18n from './eslint-rules/index.js'
...
export default antfu(
  ...
  // fastapi i18n namespace migration
  {
    files: ['**/*.ts', '**/*.tsx'],
    ignores: ['eslint-rules/**', 'i18n/**', 'i18n-config/**'],
    plugins: {
      'fastapi-i18n': fastapiI18n,
    },
    rules: {
      // 'fastapi-i18n/no-as-any-in-t': ['error', { mode: 'all' }],
      'fastapi-i18n/no-as-any-in-t': 'error',
      // 'fastapi-i18n/no-legacy-namespace-prefix': 'error',
      'fastapi-i18n/require-ns-option': 'error',
    },
  },
)
