...
import { useDocLink, useSetLocale } from '@/context/i18n'
...
export default function InviteSettingsPage() {
  ...
  const setLocaleOnClient = useSetLocale()
  const [name, setName] = useState('')
  const [language, setLanguage] = useState(LanguagesSupported[0] as typeof LanguagesSupported[number])
      ...
      <div className="flex flex-col md:w-[400px]">
        ...
        <div className="mx-auto mt-6 w-full">
          <Button variant="primary" className="w-full !text-sm">
            <a href="https://fastapi-template.com">{t('explore', { ns: 'login' })}</a>
          </Button>
        </div>
      </div>
    )
        ...
        <div className="mb-5">
          ...
          <div className="mt-1">
            <SimpleSelect
              ...
              onSelect={(item) => {
                setLanguage(item.value as typeof LanguagesSupported[number])
              }}
            />
          </div>
        </div>
