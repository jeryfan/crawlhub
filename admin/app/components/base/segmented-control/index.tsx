...
const ItemTextWrapperVariants = cva('item-text', {
  variants: {
    size: {
...
export const SegmentedControl = <T extends string | number | symbol>({
  ...
  return (
    <div className={cn(SegmentedControlVariants({ size, padding }), className)}>
        ...
        return (
          <button
            ...
            className={cn(
              ...
              SegmentedControlItemVariants({
                size,
                activeState: isSelected ? activeState : 'default',
              }),
          ...
          >
            ...
            {!isLast && !isSelected && !isNextSelected && (
              <div
                data-testid={`segmented-control-divider-${index}`}
                className="absolute right-[-1px] top-0 flex h-full items-center"
              >
