    ...
    >
      <div className="relative">
        ...
        >
          <div
            className={cn(
              ...
              !open
              && !!value
              && '!border-components-button-secondary-border !bg-components-button-secondary-bg shadow-xs hover:border-components-button-secondary-border-hover hover:!bg-components-button-secondary-bg-hover',
              open
              && !!value
              && '!border-components-button-secondary-border-hover !bg-components-button-secondary-bg-hover shadow-xs hover:border-components-button-secondary-border-hover hover:!bg-components-button-secondary-bg-hover',
              className,
            )}
          >
            {showLeftIcon && (
        ...
        <PortalToFollowElemContent className="z-[1002]">
          <div
            className={cn(
              'relative w-[240px] rounded-xl border-[0.5px] border-components-panel-border bg-components-panel-bg-blur shadow-lg',
              panelClassName,
            )}
          >
            <div className="max-h-72 overflow-auto p-1">
              {items.map(item => (
                ...
                >
                  ...
                  {value === item.value && (
                    <RiCheckLine className="h-4 w-4 shrink-0 text-util-colors-blue-light-blue-light-600" />
                  )}
                </div>
              ))}
            </div>
