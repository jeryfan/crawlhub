...
export default function Drawer({
  ...
  return (
    ...
    >
      <div
        className={cn(
          'flex h-screen w-screen justify-end',
      ...
      >
        ...
        <div
          className={cn(
            'relative z-[50] flex w-full max-w-sm flex-col justify-between overflow-hidden bg-components-panel-bg p-6 text-left align-middle shadow-xl',
            panelClassName,
          )}
        >
          <>
            ...
            {description && (
              <div className="mt-2 text-xs font-normal text-text-tertiary">
                {description}
              </div>
            )}
            {children}
