  ...
  return (
    <div className={cn(className, 'flex flex-col')}>
        ...
        {isSearching && (
          <>
            <div key="category-search" className="flex flex-col">
              <p className="system-xs-medium-uppercase mb-1 text-text-primary">
                Search
              </p>
      ...
      <div className={cn('flex items-center justify-between p-3 pb-0')}>
        <p className="system-xs-medium-uppercase mb-2 text-text-primary">
          Choose Style
        </p>
        {showStyleColors
          ? (
              ...
              <div
                ...
                className={cn(
                  ...
                  color === selectedBackground
                    ? 'ring-1 ring-components-input-border-hover'
                    : '',
                )}
                onClick={() => {
