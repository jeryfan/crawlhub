...
const meta = {
  ...
  component: FastAPILogo,
  parameters: {
    layout: 'centered',
    docs: {
      description: {
        component: 'Brand assets rendered in different contexts. FastAPILogo adapts to the active theme while other variants target specific surfaces.',
      },
    },
  },
  args: {
  ...
  tags: ['autodocs'],
} satisfies Meta<typeof FastAPILogo>
        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-divider-subtle bg-background-default p-4">
              <FastAPILogo size={size} style={style} />
