...
const DrawerPlus: FC<Props> = ({
  ...
  return (
    ...
    <Drawer
      ...
      panelClassName={cn(
        'mx-2 mb-3 mt-16 rounded-xl !p-0 sm:mr-2',
        panelClassName,
        maxWidthClassName,
      )}
    >
      <div
        className={cn(
          contentClassName,
          'flex w-full flex-col rounded-xl border-[0.5px] border-divider-subtle bg-components-panel-bg shadow-xl',
        )}
        style={{
          height,
        }}
      ...
      >
        <div
          className={cn(
            headerClassName,
            'shrink-0 border-b border-divider-subtle py-4',
          )}
        >
