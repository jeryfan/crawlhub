...
class APIBasedExtensionRequestor:
    ...
    def request(self, point: APIBasedExtensionPoint, params: dict):
        ...
        try:
            ...
            if app_config.SSRF_PROXY_HTTP_URL and app_config.SSRF_PROXY_HTTPS_URL:
                mounts = {
                    "http://": httpx.HTTPTransport(proxy=app_config.SSRF_PROXY_HTTP_URL),
                    "https://": httpx.HTTPTransport(proxy=app_config.SSRF_PROXY_HTTPS_URL),
                }
