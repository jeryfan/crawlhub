...
class ModerationFactory:
    ...
    def __init__(self, name: str, tenant_id: str, config: dict):
    ...
    async def moderation_for_inputs(self, inputs: dict, query: str = "") -> ModerationInputsResult:
        ...
        :return:
        """
        return await self.__extension_instance.moderation_for_inputs(inputs, query)
    ...
    async def moderation_for_outputs(self, text: str) -> ModerationOutputsResult:
        ...
        :return:
        """
        return await self.__extension_instance.moderation_for_outputs(text)
