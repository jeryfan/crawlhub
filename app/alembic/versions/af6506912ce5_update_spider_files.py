...
def upgrade() -> None:
    ...
    op.add_column('crawlhub_spiders', sa.Column('project_type', sa.Text(), nullable=False, server_default='single_file', comment='项目类型'))
    ...
    op.add_column('crawlhub_tasks', sa.Column('is_test', sa.Boolean(), nullable=False, server_default='false', comment='是否为测试运行'))
